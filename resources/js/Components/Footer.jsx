...
import LogoLandscape from '@/Assets/website-logo-landscape.png';
  ...
  return (
    <footer class="bg-gray-800 w-full py-8">
      <div class="max-w-screen-xl px-4 mx-auto">
        ...
        <div class="text-center text-gray-500 dark:text-gray-300 pt-10 sm:pt-12 font-light flex items-center justify-center">
          &copy; {date.getFullYear()} Smanda iLearn Dev. All rights reserved
        </div>
      </div>
    </footer>
  );
