...
const TeacherTeachingMaterial = ({ auth, materi, ctsAll }) => {
  ...
  return (
    <AuthenticatedLayoutNew auth={auth} headerTitle={'Materi'}>
      ...
      <div className="px-5 mb-4 mt-3 flex justify-between  items-center  gap-2 flex-wrap">
        <p className="text-gray-700 text-xl font-semibold">
          Daftar Materi Anda
        </p>
        <p className="text-xs text-blue-700">
          * Pilih kelas untuk mengupload materi.
        </p>
      </div>
